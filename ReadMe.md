...
[ChunkedStreamReader](https://github.com/grigdevelop/Veeam.Gzipper/blob/master/src/Veeam.Gzipper.Core/Streams/ChunkedStreamReader.cs) - класс для последовательного чтения и многопоточной обработки данных в виде кусков байтовых массивов из стрима ранее записанного с помощью класса [StreamChunkReader](https://github.com/grigdevelop/Veeam.Gzipper/blob/master/src/Veeam.Gzipper.Core/Streams/StreamChunkReader.cs). 
